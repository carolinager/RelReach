...
def parseArguments():
    ...
    parser.add_argument('-coe', '--coefficient', required=True, nargs='+', type=float, help='list of coefficients. Length must equal numInit+numPred.')
    ...
    parser.add_argument('-nPred', '--numPred', type=int, default=1, help='number of predicates. Default is 1. Currently of 1 predicate is supported')
